...
if CLIENT then
    ...
    CreateClientConVar("efgm_visuals_headbob", 1, false, true, "Adjust the bobbing motion of the players view while moving", 0, 1)
    CreateClientConVar("efgm_visuals_viewroll", 1, false, true, "Adjust the rolling motion of the players view while moving sideways", 0, 1)
