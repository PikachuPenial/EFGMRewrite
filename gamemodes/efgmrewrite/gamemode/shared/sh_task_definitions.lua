...
--     local function NewRequirement.PlayerStat(count, stat)
...
--     local function NewRequirement.QuestCompletion(taskName)
...
--     local function NewObjective.Kill(count, mapName, areaName, areaDisplayName, whenToSave)
...
--     local function NewObjective.Extract(count, mapName, extractName, extractDisplayName, whenToSave)
...
--     local function NewObjective.GiveItem(count, itemName, isFIR)
...
--     local function NewObjective.Pay(count)
...
--     local function NewObjective.QuestItem(itemName, mapName)
...
--     local function NewObjective.VisitArea(mapName, areaName, areaDisplayName, whenToSave)
...
-- -- Reward functions
    ...
    -- local function NewReward.PlayerStat(count, stat)
...
--         NewRequirement.TaskCompletion("civs1")
--     },
