...
local function CreateFonts()
    ...
    surface.CreateFont("PuristaBold18", {font = "PuristaBold", size = EFGM.ScreenScale(18), weight = 550, antialias = true, extended = true})
    surface.CreateFont("Purista18", {font = "Purista", size = EFGM.ScreenScale(18), weight = 600, antialias = true, extended = true})
