...
if CLIENT then
    ...
    CreateClientConVar("efgm_hud_scale", 1, false, false, "Adjust the scale for all user interface items", 0.5, 5)
    CreateClientConVar("efgm_controls_togglelean", 1, false, false, "Adjust if player leans are hold or toggle", 0, 1)
end
